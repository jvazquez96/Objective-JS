...
class Objective_JSListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Objective_JSParser#bloqueConstructorMultipleAsignaciones.
    def enterBloqueConstructorMultipleAsignaciones(self, ctx:Objective_JSParser.BloqueConstructorMultipleAsignacionesContext):
        pass

    # Exit a parse tree produced by Objective_JSParser#bloqueConstructorMultipleAsignaciones.
    def exitBloqueConstructorMultipleAsignaciones(self, ctx:Objective_JSParser.BloqueConstructorMultipleAsignacionesContext):
        pass
